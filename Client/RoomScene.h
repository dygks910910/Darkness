...
// 						   //x 0.8 , y 1.13
	...
	const int PLAYER2_NICKNAME_LOCATION_Y = PLAYER1_NICKNAME_LOCATION_Y + 75;

	const int PLAYER3_NICKNAME_LOCATION_X = 390 * 0.8f;
	const int PLAYER3_NICKNAME_LOCATION_Y = PLAYER2_NICKNAME_LOCATION_Y + 75;

	const int PLAYER4_NICKNAME_LOCATION_X = 390 * 0.8f;
	const int PLAYER4_NICKNAME_LOCATION_Y = PLAYER3_NICKNAME_LOCATION_Y + 75;

	const int PLAYER5_NICKNAME_LOCATION_X = 390 * 0.8f;
	const int PLAYER5_NICKNAME_LOCATION_Y = 375;
