...
InstancedNormalEffect* Effects::InstancedNormalFX = 0;
...
void Effects::InitAll(ID3D11Device* device)
{
	...
	InstancedNormalFX = new InstancedNormalEffect(device, L"FX/InstacedNormal.fxo");
}
...
#pragma region InstancedNormalEffect

 InstancedNormalEffect::InstancedNormalEffect(ID3D11Device * device, const std::wstring & filename)
	 :Effect(device, filename)
 {
	 Light1Tech = mFX->GetTechniqueByName("Light1");
	 Light2Tech = mFX->GetTechniqueByName("Light2");
 ...
 InstancedNormalEffect::~InstancedNormalEffect()
 {
 }
#pragma endregion