...
class InstancedNormalEffect : public Effect
{
public:
	InstancedNormalEffect(ID3D11Device* device, const std::wstring& filename);
	~InstancedNormalEffect();
...
public:
	...
	static InstancedNormalEffect* InstancedNormalFX;
