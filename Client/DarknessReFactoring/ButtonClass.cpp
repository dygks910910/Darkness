	...
	const int& clientWidth, const int& clientHeight)
{
	...
	mButton[0].Initialize( (WCHAR*)temp.c_str(), mBitmapWidth, mBitmapHeight);
	mButton[1].Initialize( (WCHAR*)temp1.c_str(), mBitmapWidth, mBitmapHeight);
	mButton[2].Initialize( (WCHAR*)temp2.c_str(), mBitmapWidth, mBitmapHeight);
