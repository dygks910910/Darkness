...
struct PNTIWVertex
{
	...
	bool operator==(const PNTIWVertex& rhs) const
	{
		...
		bool result1 = MathHelperFBX::CompareVector3WithEpsilon(mPosition, rhs.mPosition);
		bool result2 = MathHelperFBX::CompareVector3WithEpsilon(mNormal, rhs.mNormal);
		bool result3 = MathHelperFBX::CompareVector2WithEpsilon(mUV, rhs.mUV);
