...
void CCrown::SetWorld(const XMFLOAT4X4 & worldmtx)
{
	mObjWorld = worldmtx;
}

void CCrown::Init(ID3D11Device* d3ddevice, CModelMgr* modelMgr)
{
	ID3D11Buffer* tempIB ;
	ID3D11Buffer* tempVB;
...
void CCrown::Draw(ID3D11DeviceContext* dc, const Camera& mCam)
{
