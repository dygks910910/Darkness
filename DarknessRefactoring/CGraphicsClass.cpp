...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_GroundModel->Initialize(m_Direct3D->GetDevice(), (WCHAR*)L"data/ground01.dds", (char*)"data/ground.txt");
	if (!result)
	{
	...
	result = m_WallModel->Initialize(m_Direct3D->GetDevice(), (WCHAR*)L"data/wall01.dds", (char*)"data/wall.txt");
	if (!result)
	{
	...
	result = m_BathModel->Initialize(m_Direct3D->GetDevice(), (WCHAR*)L"data/marble01.dds", (char*)"data/bath.txt");
	if (!result)
	{
	...
	result = m_WaterModel->Initialize(m_Direct3D->GetDevice(), (WCHAR*)L"data/water01.dds", (char*)"data/water.txt");
	if (!result)
	{
