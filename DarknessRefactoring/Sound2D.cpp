...
bool Sound2D::Initialize(HWND hwnd)
{
...
bool Sound2D::InitializeDirectSound(HWND hwnd)
{
...
void Sound2D::ShutdownDirectSound()
{
...
bool Sound2D::LoadWaveFile(const char* filename, IDirectSoundBuffer8** secondaryBuffer)
{
...
void Sound2D::ShutdownWaveFile(IDirectSoundBuffer8** secondaryBuffer)
{
