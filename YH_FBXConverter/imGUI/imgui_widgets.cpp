...
bool ImGui::BeginMainMenuBar()
{
    ...
    {
        // Set window position
        // We don't attempt to calculate our height ahead, as it depends on the per-m_viewports font size. However menu-bar will affect the minimum window size so we'll get the right height.
    ...
    // Create window
    SetNextWindowViewport(viewport->ID); // Enforce m_viewports so we don't create our own m_viewports when ImGuiConfigFlags_ViewportsNoMerge is set.
